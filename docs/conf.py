...
from create_api_rst import main
    ...
    "icon_links": [
        {
            ...
            "url": "https://github.com/langchain-ai/langchain-mongodb",  # required
...
html_context = {
    ...
    "github_repo": "langchain-mongodb",  # Repo name
